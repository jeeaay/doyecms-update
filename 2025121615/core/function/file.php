 ...
 * @lastModified    2025-12-16 09:07:21
    ...
    if ($scale < 1) {
        switch ($type) {
            ...
            case 3:
                ...
                break;
            case 6:
                $img = imagecreatefrombmp($src_image);
                break;
            case 15:
                $img = imagecreatefromwbmp($src_image);
                break;
        }
        ...
        switch ($type) {
            ...
            case 3:
                ...
                break;
            case 6:
                imagebmp($new_img, $out_image);
                break;
            case 15:
                imagewbmp($new_img, $out_image);
                break;
            default:
                imagejpeg($new_img, $out_image, $img_quality);
        }
...
function watermark_img($src_image, $out_image = null, $position = null, $watermark_image = null, $watermark_text = '', $watermark_text_size = null, $watermark_text_color = null)
{
    ...
    // 如果不存在文字及图片则直接返回
    if (! $watermark_text) {
        $watermark_text = Config::get('watermark_text') ?: 'DoyeCMS';
    }
